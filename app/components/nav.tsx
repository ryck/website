  ...
  return (
    <aside className="mb-16 tracking-tight">
      <div className="lg:sticky lg:top-20">
        <nav
          id="nav"
          className=" flex items-center justify-between bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-60 lg:text-xl"
        >
          ...
          <div className="group flex flex-row space-x-3 pr-10 items-center">
            <svg
              ...
              strokeWidth={3}
              stroke="currentColor"
              className="w-8 h-8 text-slate-900 dark:text-neutral-100 rounded-sm group-hover:rotate-180 duration-600 transform-gpu	ease-in-out transition-transform"
            >
              <path
                strokeLinecap="round"
            ...
            <Link key="/" href="/">
              <span className="">Ricardo Gonzalez</span>
            </Link>
          </div>
